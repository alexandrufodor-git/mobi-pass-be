...
BEGIN
  ...
  IF NEW.email_confirmed_at IS NOT NULL THEN
    ...
    -- The function holds the service role key in its runtime env — it never lives here.
    -- We only read a scoped webhook secret from Vault (zero DB access if leaked).
