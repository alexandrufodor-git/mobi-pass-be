...
SELECT 
  ...
  -- Last modified at (on profile we used created_at since it will only be created once)
  COALESCE(p.created_at, pi.created_at, bb.updated_at, bo.updated_at) AS last_modified_at
